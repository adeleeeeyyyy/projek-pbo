    ...
    <div class="md:grid md:grid-cols-3 md:gap-6">
        <div class="md:col-span-1">
            <div class="px-4 sm:px-0">
                <h3 class="text-lg font-medium leading-6 text-slate-900">Add New Product</h3>
                <p class="mt-1 text-sm text-slate-600">Fill in the details to add a new beauty product to your catalog.
                </p>
            </div>
        </div>
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <select id="category" name="category"
                                    ...
                                    <option {{ old('category') == 'Skincare' ? 'selected' : '' }}>Skincare</option>
                                    <option {{ old('category') == 'Makeup' ? 'selected' : '' }}>Makeup</option>
                                    <option {{ old('category') == 'Lips' ? 'selected' : '' }}>Lips</option>
                                    <option {{ old('category') == 'Eyes' ? 'selected' : '' }}>Eyes</option>
                                    <option {{ old('category') == 'Face' ? 'selected' : '' }}>Face</option>
                                    <option {{ old('category') == 'Body' ? 'selected' : '' }}>Body</option>
                                </select>
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <div class="relative mt-1 rounded-md shadow-sm">
                                    <input type="text" id="price_mask" value="{{ number_format(old('price', 0), 0, ',', '.') }}" required
                            ...
                            <div class="col-span-6">
                                ...
                                <div class="mt-1 flex flex-col space-y-4">
                                    <div>
                                        <label for="image_file" class="block text-xs text-slate-500">Upload File</label>
